...
const i18n = {
  zh: {
    ...
    mainMenu: {
      ...
      import: '2. 导入/更新工作流 - 更新 .claude/ 配置（保留项目）',
      project: '3. 项目管理 - 新增/查看/删除项目',
      upgrade: '4. 升级会员 - 解锁 15+ 付费模板 (Coming Soon)',
      config: '5. 配置 - 编辑工作环境参数',
      repair: '6. 修复工作空间 - 检查并修复目录结构',
      section2: '其他',
      globalConfig: 'G. 全局配置 - 管理 ~/.claude/CLAUDE.md',
      lang: 'L. 切换语言 - 界面语言切换',
    ...
    globalConfig: {
      ...
      saved: '✓ 配置已保存',
      editFailed: '编辑失败',
      resetWarning: '警告：此操作将重置全局配置为默认模板',
      currentPath: '当前配置路径',
      confirmReset: '确认重置全局配置？',
      cancelled: '已取消',
      resetSuccess: '✓ 重置成功',
      resetFailed: '重置失败'
    },
    projectManagement: {
      ...
      cancelled: '已取消',
      deleteWarning: '警告：此操作将永久删除项目及其所有文件',
      projectId: '项目ID',
  ...
  en: {
    ...
    mainMenu: {
      ...
      import: '2. Import/Update Workflow - Update .claude/ config (keep projects)',
      project: '3. Project Management - Create/View/Delete projects',
      upgrade: '4. Upgrade - Unlock 15+ premium templates (Coming Soon)',
      config: '5. Config - Edit workspace parameters',
      repair: '6. Repair Workspace - Check and fix directory structure',
      section2: 'Other',
      globalConfig: 'G. Global Config - Manage ~/.claude/CLAUDE.md',
    ...
    uninstall: {
      title: 'Uninstall',
      warning: 'Warning: This will delete:',
    ...
    globalConfig: {
      ...
      view: 'View global config',
      edit: 'Edit global config',
      reset: 'Reset to default',
      back: 'Back to main menu',
      viewing: 'Viewing global config',
      editing: 'Editing global config',
      notExists: 'Global config file does not exist',
      path: 'Config path',
      preview: 'Content preview (first 20 lines)',
      totalLines: 'Total lines',
      created: '✓ Default config created',
      saved: '✓ Config saved',
      editFailed: 'Edit failed',
      resetWarning: 'Warning: This will reset global config to default template',
      currentPath: 'Current config path',
      confirmReset: 'Confirm reset global config?',
      cancelled: 'Cancelled',
    ...
    projectManagement: {
      ...
      selectToDelete: 'Select project to delete',
      cancelled: 'Cancelled',
      deleteWarning: 'Warning: This will permanently delete the project and all its files',
      projectId: 'Project ID',
      confirmDelete: 'Confirm delete this project?',
      deleteSuccess: '✓ Delete successful',
      deleteFailed: 'Delete failed',
      repairing: 'Repairing project index',
      repairSuccess: '✓ Repair successful',
      repairFailed: 'Repair failed',
      foundProjects: 'Found projects'
    }
  },
};
...
const DIR_NAMES = {
  zh: {
    ...
    references: '参考资料',
    stages: '阶段输出',
    contexts: '_补充资料',      // Auxiliary directory with underscore prefix
    research: '调研',
    videos: '视频',
    channels: '账号',
    outputs: '输出',
    drafts: '草稿',
    archives: '_历史版本',      // Auxiliary directory with underscore prefix
  },
  en: {
    scripts: 'scripts',
    references: 'references',
    stages: 'stages',
    contexts: '_context',        // Auxiliary directory with underscore prefix
    research: 'research',
    videos: 'videos',
    channels: 'channels',
    outputs: 'outputs',
    drafts: 'drafts',
    archives: '_archive',        // Auxiliary directory with underscore prefix
  }
};
